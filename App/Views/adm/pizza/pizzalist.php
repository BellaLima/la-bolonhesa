<div class="overflow-hidden rounded-lg border border-gray-200 shadow-md m-5">
    <button class="block uppercase mx-auto mt-5 shadow bg-indigo-800 hover:bg-indigo-700 focus:shadow-outline focus:outline-none text-white text-xs py-3 px-10 rounded"><a href="<?php echo 'http://'.APP_HOST.'/admin/pizzacreate/' ?>">Cadastrar pizza</a></button>
                    ...
                    <tr class="border-b border-black-light text-black hover:bg-gray-dark">
                            ...
                            <div class="flex items-center">
                                <div class="flex-shrink-0 w-20 h-20 hidden sm:table-cell">
                                    <img class="w-full h-full rounded-full"
                                        src="<?php echo 'http://'.APP_HOST.'/public/images/uploads/'.$pizza['imagem']; ?>"
                                        alt="" />
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="px-3 py-3">
                            <div class="flex justify-end gap-4">
                                ...
                                <a x-data="{ tooltip: 'Edite' }" href="<?php echo 'http://'.APP_HOST.'/admin/pizzaedit/'.$pizza['id']; ?>">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                                    viewBox="0 0 24 24"
