<div class="section font-semibold px-16 text-gray-800 fixed w-full top-0 flex header_section bg-red-500 shadow z-10">
  <div class="sub_head flex my-auto py-3">
    <div class="logo w-14"><img class="w-full" src="<?php echo 'http://'.APP_HOST.'/public/images/pizza-logo.png'; ?>" alt="" /></div>
    <div class="text ml-2 my-auto flex-none">Pizzaria La Bilonheza</div>
  </div>
